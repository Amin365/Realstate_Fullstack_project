            ...
            filteredProperties.map((property) => (
              ...
              >
                <CardHeader className="p-0 relative">
                  <img crossOrigin="anonymous" src={`http://localhost:4800/uploads/${property.image}`} alt="Property" className="w-full h-60 object-cover" />
                ...
                <CardFooter className="border-t px-5 py-4 flex justify-between text-gray-600 text-sm">
                  ...
                  <div className="flex items-center gap-1">
                    <Bath className="h-4 w-4" /> {property.bathrooms || 0} Baths
                  </div>
                  <div className="flex items-center gap-1">
                    <Ruler className="h-4 w-4" /> {property.length}×{property.width}{" "}
                    {property.unit}
                  </div>
                </CardFooter>
              </Card>
